        ...
        <div className="login-container">
          ...
          <div className="login-card">
            <form onSubmit={this.submitLogin} className="login-card-form" method="post">
                      ...
                      {suggestions.map(suggestion => {
                        ...
                        return (
                          <div {...getSuggestionItemProps(suggestion, { className, style })}>
                            <span onClick={() => this.larsIsAFuckingGenius(suggestion)} >{suggestion.description}</span>
                          </div>
                        )
                      })}
                    </div>
              ...
              <a className="login-forgot-password" href="#"> password dimenticata</a>
            </form>
          </div>
        </div>
      </div>
